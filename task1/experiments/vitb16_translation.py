...
if not os.path.exists(CLASSIFIER_PATH):
    raise FileNotFoundError(
        ...
        "Put your trained ViT-B/16 linear-head checkpoint "
        "at this location or change CLASSIFIER_PATH."
    )
...
OUTPUT_FILE = "task1/results/vitb16_translation_results.csv"
